...
class ColumnTestSQLServer < ActiveRecord::TestCase
  ...
  describe 'ActiveRecord::ConnectionAdapters::SQLServer::Type' do
    ...
    it 'nchar(10)' do
      ...
      #assert_obj_set_and_save :nchar_10, "五六"
    end
    ...
    it 'varbinary(max)' do
      ...
      # Basic set and save.
      binary_data.encoding.must_equal Encoding::BINARY
      obj.varbinary_max = binary_data
      obj.varbinary_max.must_equal binary_data
      obj.save!
      obj.reload.varbinary_max.must_equal binary_data.unpack("H*").first.upcase
